...
<body>
    <div id="wrapper" class="container" style="background-color: #ff9900;">
        ...
        <div>
            ...
            <a href="{{asset('upload/xplore rules.docx')}}" style="float: right;" download class="btn btn-danger white-bor"><b>Xplore Rules</b></a><br><br>
        </div>
      <div>
        ...
        <div style="margin: 0% 5%" class="scale-up-center">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSe3Qy-sYQ5zXuDkRDk36RN6WheC4P1CRr7b4oKtLhOOi_J1aA/viewform?usp=sf_link " target="_blank">
                    <li class="list-group-item link-bold">MAKE YOUR MOVE (GROUP DANCE)</li> 
                </a><br>
                </ul>
              </div>
            </div>

            <p class="text-center" style="color:black">All Rights Reserved by <a href="" style="color:#c70013"> Netaji Subhas University.</a> © 2022  || Developed With <i class="fa fa-heart" style="color:#c70013"></i> By <a target="_blank" style="color:green;"
